...
#                atttach_to,move_by , clone
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle
#             objects have:
#               fill_color,Radius,outline_thickness
#
#     f. What does a RoseWindow RENDER method do?
#            actually draws teh objects in the window
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            It is needed when you need to keep a window open as otherwise it will just open and close immediately
#
